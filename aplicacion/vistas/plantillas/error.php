...
<body>
			...
			<div class="row">
				...
				<div class="col-12 col-sm-12 col-md-12 col-lg-6">
					<div class="main-img text-center">
						<img src="/imagenes/error.png" alt="Main" class="img-fluid pb-3" width="520" height="100">

						<h2 class="fw-bold">404</h2>
						<p class="main-description pt-2"><?php echo $mensaje; ?></p>
	...
	<div class="container-fluid text-white p-3" style="background: linear-gradient(to right, #57436C,#2F4A79,#57436C);">
		<div class="mt-3">
			<h3 class="text-center fw-bold">¿Listo para comprar viajar?</h3>
