...
echo CHTML::campoLabel('Precio:', 'precio', ['class' => 'formCrud']);
echo CHTML::dibujaEtiqueta('br');
echo CHTML::campoText('precio', '', ['class' => 'form-control-sm', 'style' => 'height: 30px;']);
echo CHTML::dibujaEtiquetaCierre('div'); // Cierre del div

echo CHTML::dibujaEtiqueta('div', ['class' => 'mb-2'], '', false); // Agregar margen inferior al campo de entrada
echo CHTML::campoLabel('Fecha:', 'fecha', ['class' => 'formCrud']);
echo CHTML::dibujaEtiqueta('br');
echo CHTML::campoDate('fecha', '', ['class' => 'form-control-sm', 'style' => 'height: 30px;']);
echo CHTML::dibujaEtiquetaCierre('div'); // Cierre del div
...
echo CHTML::dibujaEtiqueta('h1', ['class' => 'position-absolute top-0 translate-middle start-50 text-center textoFondo', 'style' => 'z-index: -1;'], 'VIAJES');
...
echo CHTML::link(
    'Nuevo viaje',
    Sistema::app()->generaURL(['viajes', 'nuevo']),
