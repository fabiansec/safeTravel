...
echo CHTML::dibujaEtiqueta('h2', ['class' => 'position-absolute top-5 translate-middle start-50 text-center  mb-4 d-none d-md-block'], 'Ver Trayectos'); // Crear el elemento h1 con la clase y el texto deseados
