...
echo CHTML::dibujaEtiqueta('h2', [], 'Viaje para la Vuelta');
...
foreach ($viajesIda as $viaje) {
    ...
    echo CHTML::dibujaEtiqueta('div', ['class' => 'd-none d-lg-block table-responsive']); // Ocultar en pantallas pequeñas
    echo CHTML::dibujaEtiqueta('table', ['class' => 'table table-bordered table-striped mb-4']); // Agregar clases para ajustar el margen inferior y estilo de la tabla
